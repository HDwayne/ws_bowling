...
def run_tests() :
    ...
    print("test_calcule_score_jeu_cas_nominal() : ok")
    test_calcule_score_partie_cas_nominal()
    print("test_calcule_score_partie_cas_nominal() : ok")
    print("PHASE 1 : OK")

    # 2. tests prenant en compte les spares
    print("DEBUT PHASE 2")
    test_jeu_est_un_spare()
    print("test_jeu_est_un_spare() : ok")
    test_calcule_bonus_spare()
    print("test_calcule_bonus_spare() : ok")
    test_calcule_score_jeu_cas_spare()
    print("test_calcule_score_jeu_cas_spare() : ok")
    test_calcule_score_partie_cas_spares_seulement()
    print("test_calcule_score_partie_cas_spares_seulement() : ok")
    print("PHASE 2 : OK")

    # 3. tests prenant en compte les strikes
    print("DEBUT PHASE 3")
    test_jeu_est_un_strike()
    print("test_jeu_est_un_strike() : ok")
    test_calcule_bonus_strike_cas_nominal()
    print("test_calcule_bonus_strike_cas_nominal() : ok")
    test_calcule_bonus_strike_cas_2_strikes_consecutifs()
    print("test_calcule_bonus_strike_cas_2_strikes_consecutifs() : ok")
    test_calcule_bonus_strike_cas_1_strike_en_fin()
    print("test_calcule_bonus_strike_cas_1_strike_en_fin() : ok")
    test_calcule_score_jeu_cas_strike()
    print("test_calcule_score_jeu_cas_strike() : ok")
    test_calcule_score_partie_cas_strikes_seulement()
    print("test_calcule_score_partie_cas_strikes_seulement() : ok")
    print("PHASE 3 : OK")
